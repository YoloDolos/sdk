...
contract Market is IMarket {
        ...
        onlyOwner
    {
        ...
        require(
            ...
            "Market: cannot set App contract as zero address"
        );
     ...
     */
    function setAsk(uint256 tokenID, Ask memory ask) public override only {
        require(
     ...
     */
    function removeAsk(uint256 tokenID) external override only {
